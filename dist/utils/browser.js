...
class StorageQuotaFix extends PuppeteerExtraPlugin {
    ...
    async onPageCreated(page) {
        await page.evaluateOnNewDocument(() => {
            ...
            Object.defineProperty(navigator, "webkitTemporaryStorageQuota", {
                get: () => undefined,
            });
        });
    }
...
let browserCleanupCallback = null;
/**
...
export async function launchBrowser() {
    ...
    const attempt = (userDataDir) => puppeteer.launch({
        headless: true,
        executablePath,
        userDataDir,
    ...
    try {
        ...
        if (!String(err).includes("ProcessSingleton"))
            throw err;
